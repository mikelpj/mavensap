...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		function save_partnertemp(){
			$("#show_error").hide();
			var url='${pageContext.request.contextPath}/partnertemp/save.do';
  						...
  						<div class="content">
							...
							<div class="table">
								...
								<ul class="row">
									...
									<li class="w200"><input type="text" class="form-control input-sm" id="_cust_name"/></li>

									<li class=" w100 tr">证件类型</li>
									<li class="w200"><input type="text" class="form-control input-sm" id="_pspt_type_code"/></li>
								</ul>
								<ul class="row">
									<li class=" w100 tr">证件ID</li>
									<li class="w200"><input type="text" class="form-control input-sm" id="_pspt_id"/></li>

									<li class=" w100 tr">证件有效期</li>
									<li class="w200"><input type="text" class="form-control input-sm" id="_pspt_end_date"/></li>
								</ul>
								<ul class="row">
									<li class=" w100 tr">证件地址</li>
									<li class="w200"><input type="text" class="form-control input-sm" id="_pspt_addr"/></li>

									<li class=" w100 tr">通信地址</li>
									<li class="w200"><input type="text" class="form-control input-sm" id="_post_address"/></li>
								</ul>
								<ul class="row">
									<li class=" w100 tr">邮编</li>
									<li class="w200"><input type="text" class="form-control input-sm" id="_post_code"/></li>

									<li class=" w100 tr">联系人</li>
									<li class="w200"><input type="text" class="form-control input-sm" id="_post_person"/></li>
								</ul>
								<ul class="row">
									...
									<li class="w200"><input type="text" class="form-control input-sm" id="_email"/></li>
								</ul>
								<ul class="row">
									...
									<li class="w200"><input type="text" class="form-control input-sm" id="_oper_type"/></li>
								</ul>
								<ul class="row">
								...
								<ul class="last row">
									<li class="w100"><button onclick="save_partnertemp();" type="submit" class="btn btn-warning btn-sm btn-block">保存</button></li>
