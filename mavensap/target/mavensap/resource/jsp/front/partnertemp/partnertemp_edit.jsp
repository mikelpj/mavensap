...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		function update_partnertemp(){
			$("#show_error").hide();
			var url='${pageContext.request.contextPath}/partnertemp/update.do';
						...
						<div class="heading">
  						...
  						<div class="content">
							...
							<div class="table">
								...
								<ul class="last row">
									<li class="w100"><button onclick="update_partnertemp();" type="submit" class="btn btn-warning btn-sm btn-block">更新</button></li>
