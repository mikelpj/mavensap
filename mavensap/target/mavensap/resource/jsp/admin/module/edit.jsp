  						...
  						<div class="content">
							...
							<div class="table">
								...
								<ul class="row">
									...
									<li class="w200"><input type="text" class="form-control input-sm" id="_module_name" value="${data.module_name}"/></li>
								
									<li class=" w100 tr">父模块ID</li>
									<li class="w200"><input type="text" class="form-control input-sm" id="_parentid" value="${data.parentid}"/></li>
								</ul>
								...
								<ul class="last row">
									<li class="w100"><button onclick="update_module();" type="submit" class="btn btn-warning btn-sm btn-block">更新</button></li>
