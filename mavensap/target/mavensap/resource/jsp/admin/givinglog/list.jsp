...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		function query_log(){
			$("#show_error").hide();
			var url='${pageContext.request.contextPath}/givinglog_list.do';
...
<body class="bodybg">
		...
		<!-- 页头结束-->
         <div id="contain">
         	<div class="box">
						<div class="heading">
    						<h1><a href="${pageContext.request.contextPath}/welcome.do">首页</a>&nbsp;&gt;&nbsp;<a href="${pageContext.request.contextPath}/admin/givinglog_list.do">流量赠送查询</a></h1>
  						</div>
  						<div class="content">
							...
							<div class="table">
							<form name="queryform" method="post" action="${pageContext.request.contextPath}/admin/givinglog_list.do">
								...
								<ul class="row">
									<li class="w100 tr">合作商</li>
									<li class="w200"><input type="text" id="cust_name" class="form-control input-sm" value="${cust_name}" /></li>
									<li class="w200 tr"><input type="checkbox" id="state" value="${state}" />失败记录</li>
								</ul>
								<ul class="row">
									...
									<li class=" w100 tr">业务号码</li>
									<li class="w200"><input type="text" id="serial_number" class="form-control input-sm" value="${serial_number}"/></li>
									
								</ul>
								<ul class="row">
									<li class=" w100 tr">赠送日期</li>
									<li class="w200"><input type="text" id="update_time" class="form-control input-sm" value="${update_time}"/></li>
									<!--  <li class="w100 tr">生效月份</li>
									<li class="w200"><input type="text"   id="start_date" value="${start_date}" class="form-control input-sm"/></li>-->
									<li class="w100 tr"><button onclick="query_log();" type="button" class="btn btn-warning btn-sm btn-block">查询</button></li>
								</ul>
