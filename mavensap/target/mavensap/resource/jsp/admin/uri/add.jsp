  						...
  						<div class="content">
							...
							<div class="table">
								...
								<ul class="row">
									...
									<li class="w200"><input type="text" class="form-control input-sm" id="_uri"/></li>
								...
								<ul class="row">
									...
									<li class="w200"><input type="text" class="form-control input-sm" id="_deletable"/></li>
								</ul>
								<ul class="last row">
									<li class="w100"><button onclick="save_uri();" type="submit" class="btn btn-warning btn-sm btn-block">保存</button></li>
