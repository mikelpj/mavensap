...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		function save_department(){
			$("#show_error").hide();
			var url='${pageContext.request.contextPath}/admin/department_save.do';
  						...
  						<div class="content">
							...
							<div class="table">
								...
								<ul class="row">
									...
									<li class="w200"><input type="text" class="form-control input-sm" id="_depart_name"/></li>

									<li class=" w100 tr">上级部门</li>
									<li class="w200"><input type="text" class="form-control input-sm" id="_super_depart_id"/></li>
								</ul>
								<ul class="row">
								...
								<ul class="last row">
									<li class="w100"><button onclick="save_department();" type="submit" class="btn btn-warning btn-sm btn-block">保存</button></li>
