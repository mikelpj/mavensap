...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		function update_roleuri(){
			$("#show_error").hide();
			var url='${pageContext.request.contextPath}/admin/roleuri_update.do';
  						...
  						<div class="content">
							...
							<div class="table">
								...
								<ul class="row">
									...
									<li class="w200"><input type="text" class="form-control input-sm" id="_roleid" value="${data.roleid}"/></li>
								
									<li class=" w100 tr">资源ID</li>
									<li class="w200"><input type="text" class="form-control input-sm" id="_uriid" value="${data.uriid}"/></li>
								</ul>
								...
								<ul class="last row">
									<li class="w100"><button onclick="update_roleuri();" type="submit" class="btn btn-warning btn-sm btn-block">更新</button></li>
