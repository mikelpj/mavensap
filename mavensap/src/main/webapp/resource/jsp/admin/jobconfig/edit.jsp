...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		$(document).ready(function(){
			$("#bootrun").val($("#bootrun_val").val());
		});
		function update_jobconfig(){
			$("#show_error").hide();
			var url='${pageContext.request.contextPath}/admin/jobconfig_update.do';
  						...
  						<div class="content">
							...
							<div class="table">
								...
								<ul class="row gry">
									...
									<li class="w300"><input type="text" class="form-control input-sm" id="job_name" value="${data.JOB_NAME}"/></li>
								</ul>
								<ul class="row gry">
									<li class=" w100 tr">任务类路径:</li>
									<li class="w300"><input type="text" class="form-control input-sm" id="job_class" value="${data.JOB_CLASS}"/></li>
								</ul>
								<ul class="row gry">
									<li class=" w100 tr">Cron表达式:</li>
									<li class="w300"><input type="text" class="form-control input-sm" id="job_cronexp" value="${data.JOB_CRONEXP}"/></li>
								</ul>
								<ul class="row gry">
								...
								<ul class="row gry">
									...
									<li class="w300"><select class="form-control" id="bootrun"><option value="0">否</option><option value="1">自动启动(服务重启时)</option></select></li>
								</ul>
								<ul class="title"><li>部分字段:</li></ul>
								<ul class="last row">
									<li class="w100"><button onclick="update_jobconfig();" type="button" class="btn btn-warning btn-sm btn-block">更新</button></li>
								...
								<div style="clear:both;">
									...
									<input type="hidden" id="bootrun_val" value="${data.JOB_BOOTRUN}"/>
								</div>
							</div>
						</div>
            	</div>
