...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		function update_role(){
			$("#show_error").hide();
			var url='${pageContext.request.contextPath}/admin/role_update.do';
  						...
  						<div class="content">
							...
							<div class="table">
								...
								<ul class="row">
									...
									<li class="w200"><input type="text" class="form-control input-sm" id="_role_name" value="${data.role_name}"/></li>
								...
								<ul class="row">
									...
									<li class="w200"><input type="text" class="form-control input-sm" id="_role_type" value="${data.role_type}"/></li>
								
								<ul class="last row">
									<li class="w100"><button onclick="update_role();" type="submit" class="btn btn-warning btn-sm btn-block">更新</button></li>
