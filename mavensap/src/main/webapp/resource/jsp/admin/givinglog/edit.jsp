...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		function update_givinglog(){
			$("#show_error").hide();
			var url='${pageContext.request.contextPath}/admin/givinglog_update.do';
  						...
  						<div class="content">
							...
							<div class="table">
								...
								<ul class="row">
									...
									<li class="w200"><input type="text" class="form-control input-sm" id="_p_serial_number" value="${data.p_serial_number}"/></li>
								</ul>
								
								<ul class="row">
									<li class=" w100 tr">主用户</li>
									<li class="w200"><input type="text" class="form-control input-sm" id="_p_user_id" value="${data.p_user_id}"/></li>
								...
								<ul class="row">
									...
									<li class="w200"><input type="text" class="form-control input-sm" id="_batch_id" value="${data.batch_id}"/></li>
								
									<li class=" w100 tr">原始流量</li>
									<li class="w200"><input type="text" class="form-control input-sm" id="_f_flow" value="${data.f_flow}"/></li>
								</ul>
								
								<ul class="row">
									<li class=" w100 tr">是否使用完</li>
									<li class="w200"><input type="text" class="form-control input-sm" id="_is_over" value="${data.is_over}"/></li>
								
									<li class=" w100 tr">剩余流量</li>
									<li class="w200"><input type="text" class="form-control input-sm" id="_e_flow" value="${data.e_flow}"/></li>
								</ul>
								
								<ul class="row">
									<li class=" w100 tr">必须是BSS的资费ID</li>
									<li class="w200"><input type="text" class="form-control input-sm" id="_u_product_id" value="${data.u_product_id}"/></li>
								...
								<ul class="row">
									...
									<li class="w200"><input type="text" class="form-control input-sm" id="_u_data_flow" value="${data.u_data_flow}"/></li>
								...
								<ul class="row">
									...
									<li class="w200"><input type="text" class="form-control input-sm" id="_sync_state" value="${data.sync_state}"/></li>
								...
								<ul class="row">
									...
									<li class="w200"><input type="text" class="form-control input-sm" id="_fail_reason" value="${data.fail_reason}"/></li>
								
									<li class=" w100 tr">操作时间</li>
									<li class="w200"><input type="text" class="form-control input-sm" id="_start_time" value="${data.start_time}"/></li>
								</ul>
								
								<ul class="row">
									<li class=" w100 tr">操作时间</li>
									<li class="w200"><input type="text" class="form-control input-sm" id="_end_time" value="${data.end_time}"/></li>
								
								<ul class="last row">
									<li class="w100"><button onclick="update_givinglog();" type="submit" class="btn btn-warning btn-sm btn-block">更新</button></li>
