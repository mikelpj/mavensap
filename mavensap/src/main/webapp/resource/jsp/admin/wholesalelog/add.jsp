...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		function save_wholesalelog(){
			...
			$("#show_error").hide();
			var url='${pageContext.request.contextPath}/admin/wholesalelog_save.do';
		...
		function getPartnerDes(){
			$("#show_error").hide();
			var url='${pageContext.request.contextPath}/admin/wholesalelog_getPartnerDes.do';
			var phone = $("#_phone").val();
			
			if(phone.length<1){showmsg('电话号码不能为空');return;};
			
			if(!isMobile(phone)){showmsg('请输入正确的联通手机号码');return;};
...
<body class="bodybg">
		...
		<!-- 页头结束-->
         <div id="contain">
         	...
         	<div class="box">
						<div class="heading">
    						<h1><a href="${pageContext.request.contextPath}/welcome.do">首页</a>&nbsp;&gt;&nbsp;<a href="${pageContext.request.contextPath}/admin/wholesalelog_add.do">流量批发管理</a>&nbsp;&gt;&nbsp;流量批发受理</h1>
  						</div>
  						<div class="content">
