...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		function query_partnertemp(){
			$("#show_error").hide();
			var url='${pageContext.request.contextPath}/partnertemp/query.do';
         			...
         			<div class="box">
						<div class="heading">
  						...
  						<div class="content">
							...
							<div class="table">
								<ul class="title"><li>查询合作方临时资料</li></ul>
								<ul class="row">
								...
								<!--loop end-->
								<ul class="last row">
									<li class="w100"><button onclick="query_partnertemp();" type="submit" class="btn btn-warning btn-sm btn-block">批量操作1</button></li>
